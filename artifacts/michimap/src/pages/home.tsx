                ...
                <div className="border-t border-border bg-card/50 px-6 py-6 space-y-4">
                  ...
                  {user ? (
                    ...
                    <a href="/api/login"
                      ...
                      className={cn("w-full flex items-center justify-center gap-2 bg-primary text-primary-foreground font-semibold rounded-xl py-3 text-sm shadow-sm hover:opacity-90 transition-all", !agreedToTerms && "opacity-40 pointer-events-none")}>
                      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                        <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 3a3 3 0 110 6 3 3 0 010-6zm0 14.2a7.3 7.3 0 01-6.09-3.26C5.93 14.19 9.46 13.3 12 13.3s6.07.89 6.09 2.64A7.3 7.3 0 0112 19.2z" />
                      </svg>
                      Sign in to Download
                    </a>
                  )}
