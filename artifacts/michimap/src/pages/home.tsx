                  ...
                  {user ? (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <a href="/api/auth/google"
                        ...
                        className={cn("flex items-center justify-center gap-2 bg-white text-[#333] border border-[#ddd] font-medium rounded-xl py-3 text-sm shadow-sm hover:bg-gray-50 transition-colors", !agreedToTerms && "opacity-40 pointer-events-none")}>
                      ...
                      <a href="/api/auth/linkedin"
                        onClick={e => { if (!agreedToTerms) { e.preventDefault(); toast({ title: "Agreement Required", description: "Please agree to the terms first.", variant: "destructive" }); } }}
                        className={cn("flex items-center justify-center gap-2 bg-[#0A66C2] text-white font-medium rounded-xl py-3 text-sm shadow-sm hover:bg-[#004182] transition-colors", !agreedToTerms && "opacity-40 pointer-events-none")}>
